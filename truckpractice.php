...
//$req_url = "https://www.nascar.com/cacher/2019/3/4845/practice{$num}.json";
$req_url = "https://www.nascar.com/cacher/2019/3/{$raceID}/practice{$num}.json";
...
function add_qualify($raceID){
  $grid = [];
  //$req_url = "https://www.nascar.com/cacher/2019/3/4845/qualification.json";
  $req_url = "https://www.nascar.com/cacher/2019/3/{$raceID}/qualification.json";
    $response = curl_get($req_url);
    $response = json_decode($response, true);
    //var_dump($response);
    //$response = $response['starting_grid'];
